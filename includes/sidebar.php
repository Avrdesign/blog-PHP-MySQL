...
<div class="block">
    ...
    <div class="block__content">
        <div class="articles articles__vertical">
            ...
            /*Вывод 3 статей отсортированных - самые просматриваемые вначале*/
            ?>
...
<div class="block">
    ...
    <div class="block__content">
        <div class="articles articles__vertical">
            ...
            /*Вывод последних 5 отзывов отсортированных - самые новые вначале*/
            ?>
            ...
            while($comment = mysqli_fetch_assoc($comments))
            {
                ?>
                <article class="article">
                    <div class="article__image" style="background-image: url(https://gravatar.com/avatar/<?php echo md5($comment['email']); ?>);"></div>
                    <div class="article__info">
